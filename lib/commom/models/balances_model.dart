...
class BalancesModel {
  ...
  BalancesModel({required this.totalIncome, required this.totalOutcome, required this.totalBalance});
  ...
  factory BalancesModel.fromJson(String source) => BalancesModel.fromMap(json.decode(source) as Map<String, dynamic>);
}
